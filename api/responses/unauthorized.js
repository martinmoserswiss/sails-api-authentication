...
module.exports = function unauthorized (data, options) {
  ...
  // Compile log
  var controller = typeof req.options.controller !== 'undefined' ? req.options.controller : 'unknown';
  var endpoint = typeof req.options.action !== 'undefined' ? req.options.action : 'unknown';
  var message = typeof data !== 'undefined' && typeof data.message !== 'undefined' ? data.message : '';
